...
function generatePassword() {
  ...
  if (passwordLength >= 8 && passwordLength <= 128) {
    ...
    console.log("User has selected to have " + passwordLength + " characters for password length.")
  }

  if (passwordLength < 8 || passwordLength > 128) {
    alert("Password length must be more than 7 characters and less than 129 characters. Please try again.");
    console.log("User has selected to have " + passwordLength + " characters for password length. This is an invalid option.")
    return null;
  }
